      ...
      <div className="max-w-2xl mx-auto space-y-16">
        ...
        <div className="space-y-6">
          ...
          <p className="text-[1rem] leading-[1.75] text-black/80">
            From startups to scale-ups to enterprise companies, I am able to develop and lead your product strategy and enhance user experiences for real, measurable results.
          </p>
        </div>
